...
//        setenv("REQUESTS_CA_BUNDLE", pemUrl.path.toCString(), 1)
        ...
        setenv("CCC_OVERRIDE_OPTIONS", "#^--target=wasm32-wasi +-fno-exceptions +-lc-printscan-long-double", 1) // silently add "--target=wasm32-wasi" at the beginning of arguments
